...
tlCenter
  .to(".blob--center .animated-blob", { morphSVG: "#center-blob3", duration: duration, ease: "linear" })
  .to(".blob--center .animated-blob", { morphSVG: "#center-blob4", duration: duration, ease: "linear" })
  .to(".blob--center .animated-blob", { morphSVG: "#center-blob2", duration: duration, ease: "linear" })
  .to(".blob--center .animated-blob", { morphSVG: centerBlob1, duration: duration, ease: "linear" });
...
tlTopLeft
  .to(".blob--topLeft .animated-blob", { morphSVG: "#topLeft-blob3", duration: duration, ease: "linear" })
  .to(".blob--topLeft .animated-blob", { morphSVG: "#topLeft-blob4", duration: duration, ease: "linear" })
  .to(".blob--topLeft .animated-blob", { morphSVG: "#topLeft-blob2", duration: duration, ease: "linear" })
  .to(".blob--topLeft .animated-blob", { morphSVG: topLeftBlob1, duration: duration, ease: "linear" });
...
tlTopRight
  .to(".blob--topRight .animated-blob", { morphSVG: "#topRight-blob3", duration: duration, ease: "linear" })
  .to(".blob--topRight .animated-blob", { morphSVG: "#topRight-blob4", duration: duration, ease: "linear" })
  .to(".blob--topRight .animated-blob", { morphSVG: "#topRight-blob2", duration: duration, ease: "linear" })
  .to(".blob--topRight .animated-blob", { morphSVG: topRightBlob1, duration: duration, ease: "linear" });
...
tlDownRight
  .to(".blob--downRight .animated-blob", { morphSVG: "#downRight-blob3", duration: duration, ease: "linear" })
  .to(".blob--downRight .animated-blob", { morphSVG: "#downRight-blob4", duration: duration, ease: "linear" })
  .to(".blob--downRight .animated-blob", { morphSVG: "#downRight-blob2", duration: duration, ease: "linear" })
  .to(".blob--downRight .animated-blob", { morphSVG: downRightBlob1, duration: duration, ease: "linear" });
...
tlDownLeft
  .to(".blob--downLeft .animated-blob", { morphSVG: "#downLeft-blob3", duration: duration, ease: "linear" })
  .to(".blob--downLeft .animated-blob", { morphSVG: "#downLeft-blob4", duration: duration, ease: "linear" })
  .to(".blob--downLeft .animated-blob", { morphSVG: "#downLeft-blob2", duration: duration, ease: "linear" })
  .to(".blob--downLeft .animated-blob", { morphSVG: downLeftBlob1, duration: duration, ease: "linear" });
